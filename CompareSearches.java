...
public class CompareSearches{
	...
	* 			    to find a designated number in an array    **
	...
	**********************************************************/
	...
	public static void main(String[] args) throws IOException{
        ...
        int num = 0;																						//create a variable to hold the wanted number
		...
		try {
            ...
            System.out.println("Item value: \t" + num + "\n");												//print the number that was searched for (seq)
            ...
            System.out.println("Item value: \t" + num + "\n");												//print the number that was searched for (bin)
